...
def generate_launch_description():
    ...
    my_package_name='myrt_robot'
    sim_mode = LaunchConfiguration('sim_mode')
    #im_mode_dec = DeclareLaunchArgument('sim_mode', default_value='false')
    ...
    tracker_launch = IncludeLaunchDescription(
                PythonLaunchDescriptionSource([os.path.join(
                    get_package_share_directory('energy_tracker'), 'launch', 'energy_tracker.launch.py')]),
                    launch_arguments={
